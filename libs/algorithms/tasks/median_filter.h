#ifndef ARRAY_MEDIAN_FILTER_H
#define ARRAY_MEDIAN_FILTER_H
...
void test_medianFilterEmptyFile() {
    const char filename[] = "C:\\Users\\bykan\\Desktop\\Lab20\\3_test_1.txt";
...
void test_medianFilterUnitFile() {
    const char filename[] = "C:\\Users\\bykan\\Desktop\\Lab20\\3_test_2.txt";
...
void test_medianFilterSmallMatrix() {
    const char filename[] = "C:\\Users\\bykan\\Desktop\\Lab20\\3_test_3.txt";
...
void test_medianFilterAverageMatrix() {
    const char filename[] = "C:\\Users\\bykan\\Desktop\\Lab20\\3_test_4.txt";
...
void test_medianFilterBigMatrix() {
    const char filename[] = "C:\\Users\\bykan\\Desktop\\Lab20\\3_test_5.txt";
...
void test_medianFilter() {
    test_medianFilterEmptyFile();
    test_medianFilterUnitFile();
    test_medianFilterSmallMatrix();
    test_medianFilterAverageMatrix();
    test_medianFilterBigMatrix();
}

#endif //ARRAY_MEDIAN_FILTER_H